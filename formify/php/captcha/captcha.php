...
Image generating from https://github.com/claviska/simple-php-captcha

To use with Formify 2.0 Package
...
{
	if($_SESSION['code'] && strtolower($_SESSION['code']) == strtolower($_POST['captcha']))
	{
		echo 'success';
	}
	else
...
else
{
	...
	while( strlen($captcha_config['code']) < $length ) {
		$captcha_config['code'] .= substr($captcha_config['characters'], rand(1, strlen($captcha_config['characters'])), 1);
	}
